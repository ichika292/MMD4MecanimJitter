...
{
    [System.Serializable]
    public class BoneJitterParameter : JitterParameterBase
    {
        //Editor用
        public bool isXAxis;
        ...
        public BoneJitterParameter(AnimationCurve curve, bool loop, bool isXAxis = false) : base(curve, loop)
        {
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(BoneJitterParameter))]
